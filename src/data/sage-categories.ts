...
export const bighornCategories: BighornCategory[] = [
  {
    ...
    seoBullets: [
      ...
      'Free Las Vegas Valley delivery on orders over $500',
      'Rush turnaround as fast as 48 hours when blanks are in stock',
    ],
  ...
  },
  {
    ...
    seoBullets: [
      ...
      '24-hour curated quotes with mockups',
    ],
